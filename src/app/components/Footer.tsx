...
export default function Footer() {
  return (
    ...
    <div className='flex justify-center space-x-5 transition-tranform duration-500 ease-in-out transform hover:scale-105'>
     ...
     ``<img src="https://img.icons8.com/fluent/30/000000/linkedin-2.png" 
      ...
      <a href="https://messenger.com" target='blank' rel='nofollow noopener'>
     ...
     <p className='text-center hover:text-cyan-600 text-amber-400 font-medium mb-8'>
      2024 Nazia Siraj.All Rights Reserved </p>
      <br />
      <br />
      <br />
